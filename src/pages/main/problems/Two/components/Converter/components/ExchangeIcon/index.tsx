import { ExchangeIconWrapper } from './styles';

type IExchangeIcon = React.HTMLAttributes<HTMLDivElement>;

function ExchangeIcon({ ...rest }: IExchangeIcon) {
    return (
        <ExchangeIconWrapper {...rest}>
            <svg
                aria-hidden="true"
                focusable="false"
                role="none"
